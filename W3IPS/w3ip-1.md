...
4. **type**="name", if **value** is in the form of **name**.**nsProvider[:chainId]**. In this case, the actual value of the argument will be **address**, which is obtained from **nsProvider**, e.g., eth, w3q, etc.
5. else **type**="bytes"
